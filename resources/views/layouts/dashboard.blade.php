...
<head>
    ...
    <title>Cyber Counselor Connect</title>
    ...
    <link rel="shortcut icon" href="{{ url('img/cy_1.ico') }}" type="image/x-icon">
</head>
...
<body id="page-top">
    ...
    <div class="main-wrapper">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                    <div class="sidebar-brand-text mx-3">
                        <img src="{{ URL::asset('img/cy.jfif') }}" alt="" width="50" height="50"
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item" href="{{ url('/auth/logout') }}" data-toggle="modal"
                    ...
                    <div class="flex-con d-flex flex-column">
        ...
        <script src="https://kit.fontawesome.com/d3062b7294.js" crossorigin="anonymous"></script>
</body>
